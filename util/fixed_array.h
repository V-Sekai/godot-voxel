...
// I couldn't find a way to enable boundary checks without failing to link my
// module with the rest of Godot...
template <typename T, unsigned int N> class FixedArray {
public:
  inline FixedArray() {}

  inline FixedArray(T defval) { fill(defval); }
