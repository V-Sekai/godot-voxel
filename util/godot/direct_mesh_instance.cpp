...
DirectMeshInstance::~DirectMeshInstance() { destroy(); }

bool DirectMeshInstance::is_valid() const { return _mesh_instance.is_valid(); }
...
Ref<Mesh> DirectMeshInstance::get_mesh() const { return _mesh; }
