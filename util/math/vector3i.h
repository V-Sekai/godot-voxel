...
struct VoxelVector3i {
	...
	_FORCE_INLINE_ VoxelVector3i(const VoxelVector3i &other) {
		*this = other;
	}
	...
	// TODO Deprecate
	_FORCE_INLINE_ bool is_contained_in(const VoxelVector3i &min, const VoxelVector3i &max) {
	...
	inline VoxelVector3i floordiv(const VoxelVector3i d) const {
		return VoxelVector3i(::floordiv(x, d.x), ::floordiv(y, d.y), ::floordiv(z, d.z));
	}
	...
	static inline VoxelVector3i from_zxy_index(unsigned int i, const VoxelVector3i area_size) {
		VoxelVector3i pos;
		pos.y = i % area_size.y;
	...
	static inline VoxelVector3i min(const VoxelVector3i a, const VoxelVector3i b) {
		return VoxelVector3i(::min(a.x, b.x), ::min(a.y, b.y), ::min(a.z, b.z));
	}
};

_FORCE_INLINE_ VoxelVector3i operator+(const VoxelVector3i &a, const VoxelVector3i &b) {
...
_FORCE_INLINE_ VoxelVector3i operator/(const VoxelVector3i &a, const VoxelVector3i &d) {
...
_FORCE_INLINE_ int VoxelVector3i::distance_sq(const VoxelVector3i &other) const {
